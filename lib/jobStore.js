  ...
  for (const cand of candidates) {
    ...
    if (current && current.status === 'queued') {
      try {
        ...
        if (verify && verify.status === 'transcribing' && verify.claimedBy === myClaimToken) {
          // We are the owner
          return verify;
        }
...
module.exports = { JOBS_DIR, jobDir, createJob, readJob, updateJob, nextQueuedJob, claimNextQueuedJob, deleteJob, jobStorageBytes };
